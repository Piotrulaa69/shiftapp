...
const styles = StyleSheet.create({
  ...
  dayShort: { fontSize: 10, fontWeight: '600', color: theme.colors.textMuted, marginBottom: 4 },
  dayShortSelected: { color: 'rgba(255,255,255,0.75)' },
  dayNum: { fontSize: 15, fontWeight: '700', color: theme.colors.text, marginBottom: 4 },
